...
try:
    ...
    raise ImportError("FastAPI is not installed. Please install FastAPI to use this module: 'pip install fastapi'")
else:
    fastapi_installed = True

from .error_codes import AppErrorCodes
...
if fastapi_installed:
    async def custom_exception_handler(request: Request, exc: Union[CustomHTTPException, Exception]) -> JSONResponse:  # noqa
        """
...
if fastapi_installed:
    async def bad_request_error_handler(
        ...
        :type request: Request
        :param exc: Exception object.
        :type exc: Union[RequestValidationError, Exception]
        :return: JSONResponse containing the error code and message.
        :rtype: JSONResponse
        """
